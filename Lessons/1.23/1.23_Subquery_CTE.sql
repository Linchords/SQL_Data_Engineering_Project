...
-- What are subqueries vs CTEs 
-- They are used for organizing and simplifying complex queries.
 -- Subqueries are queries nested inside a larger query done by putting the query in parenthesis 
-- CTEs define a temporary result set that you can reference.
...
-- Show each jobs salary nect to the overall market median 
SELECT 
    job_title_short,
    salary_year_avg,
    (
...
-- Existence Filtering Using subqueries in the WHERE clause
-- Subquery
SELECT *
