-- CTA means create table as select
-- CTAs Create table as SELECT 
-- This is create table based off a query, the 'AS' connects the create keyword to the query
...
SELECT
    ...
    jpf.salary_year_avg,
    jpf.salary_hour_avg,
    cd.company_id AS company_id_cd,
    cd.name,
...
-- VIEW is used to create stored query definition
...
SELECT COUNT(*) senior_jobs_flat_temp;
